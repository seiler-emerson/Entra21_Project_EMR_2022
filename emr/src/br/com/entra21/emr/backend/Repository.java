...
public class Repository {
	...
	public static void generateDataPatients() {
		patients.put("paciente001", new Patient("Sheldon Li Cooper", "010.110.010-01", "Mary Cooper", "George Cooper", "Av Los Robles Avenue, 2311 Pasadena", "m", LocalDate.of(1980, 2, 26)));
		patients.get("paciente001").setAppointments(new ArrayList<>());
	...
	public static void exibir() {
		...
		System.out.println("Full name: "+patients.get("paciente001").getName());
		System.out.println("CPF: "+patients.get("paciente001").getCpf());
		System.out.println("Mother name: "+patients.get("paciente001").getNameMother());
		System.out.println("Name Father: "+patients.get("paciente001").getNameFather());
		System.out.println("Adress: "+patients.get("paciente001").getAddress());
		System.out.println("Genre: "+patients.get("paciente001").getGenre());
		System.out.println("Birth date: "+patients.get("paciente001").getBirth());
