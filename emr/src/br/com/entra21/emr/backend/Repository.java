...
public class Repository {
	...
	public static void generateDataBase() {
		generateDataPatients(); 			//Generate dataBase Patients
		generateDataDoctors();				//Generate dataBase Doctors
		generateDataAppointments();			//Generate dataBase Appointments
		generateDataStates();				//Generate dataBase States Brazil
		generateDataLogin();				//Generate dataBase Logins
	}
